...
FINAL_DIR = Path("/Users/yuumix/Projects/zensical/yuumixcode.github.io/out/yuumix-ip/final-v2")
EXPR_DIR = FINAL_DIR / "expressions"
OUT_PATH = FINAL_DIR / "final-v2-4x3-board.png"
...
expr_board_rgb.save(FINAL_DIR / "expression-board-3x3-v2.png", "PNG", optimize=True)
